...
const authentication = async () => {
  ...
  let clientId = "1r1q8zobsj2bs4b1jj8o";
  let authUrl =
...
function initTableAttachments() {
  ...
  if (gloshotScreens) {
    ...
    document.write(`<table id="tblAttachment" border='1' width='200'>`);
    document.write("<tr><th>Filename</th><th>Remove</th></tr>");
    console.log(screens);
    let i = 0;
    if (screens) {
      screens.forEach(screen => {
        document.write(`
          ...
          <span><img src="${
            screen.data
          }" width="500px" height="300px"></span></a> 
          </td><td>
          <button name="btnRemoveAttach" value="${
            screen.originalName
          }">X</button>
          </td></tr>`);
        i++;
    ...
    Array.prototype.forEach.call(btnsRemoveAttach, function addClickListener(
      btn
    ) {
